...
class CommunityCellInfoView:UIView{
    ...
    private func configure(){
        ...
        NSLayoutConstraint.activate([
            ...
            indvidualsImgView.topAnchor.constraint(equalTo: topAnchor,constant: 3),
            indvidualsImgView.heightAnchor.constraint(equalToConstant: 53),
            ...
            inGameShares.topAnchor.constraint(equalTo: topAnchor, constant: padding),
            ...
            totalShares.topAnchor.constraint(equalTo: topAnchor, constant: padding),
            totalShares.heightAnchor.constraint(equalToConstant: 50),
            totalShares.widthAnchor.constraint(equalToConstant: 60),
            
            
            priceLabel.topAnchor.constraint(equalTo: topAnchor, constant: padding),
